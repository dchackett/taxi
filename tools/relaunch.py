...
parser.add_argument('--dshell', type=str, default=None, help='Directory to find taxi.sh in (default: same as relaunch.py)')
...
if parg.dshell is None:
    taxi_shell_script = os.path.dirname(os.path.abspath(__file__)) + '/taxi.sh'
else:
