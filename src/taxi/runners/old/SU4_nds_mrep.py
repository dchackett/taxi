...
parser.add_argument('--k4',       type=float, required=True,  help='Kappa parameter for fundamental rep fermions.')
...
## dynamical fermions
nkappas 2""".format(Ns=Ns, Nt=Nt, seed=seed, beta=beta, gammarat=gammarat, maxcgobs=maxcgobs, cgtol=cgtol)
...
""".format(k4=k4, k6=k6, shift=shift, maxcgpf=maxcgpf, cgtol=cgtol)
